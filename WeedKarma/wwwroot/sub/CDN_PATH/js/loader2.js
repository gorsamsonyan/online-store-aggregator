(function() {
    ...
    var t;
    switch (window.location.hostname.indexOf("vteam.am")) {
        case -1:
            switch (0 === window.location.hostname.indexOf("192.168") && (t = "local"), (0 === window.location.hostname.indexOf("www.resn.co.nz") || 0 === window.location.hostname.indexOf("resn.co.nz")) && (t = "local"), window.location.hostname) {
                case "www.su.am":
                case "localhost":
                case "0.0.0.0":
                    t = "local";
                    break;
                case "subaru.alpha.resn.co.nz":
                    t = "staging"
            }
            break;
        default:
    ...
    var i = {
        ...
        STRUCTURE_JSON: {
            ...
            local: "CDN_PATH/data/temp_hcih.json",
            staging: "CDN_PATH/data/temp_hcih.json",
        ...
        SITE_URLS: {
            testing: {
                mobile: "http://subaru.resn.co.nz/index_mobile.html",
                desktop: "http://subaru.resn.co.nz"
            },
            local: {
